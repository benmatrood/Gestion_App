<div>
    <div class="row p-4 pt-5 ">
        <div class="col-12">
            <div class="card" style="height: 75vh;margin-right: 8rem;margin-left:8rem;">
                <div class="card-header " style="background-color: #10038f;color: #fff;">
                    <h3 class="card-title d-flex align-items-center"> <i class="fa fa-list fa-2x"><span
                                class="mr-2"></span></i> Listes des Palierprivileges d'articles</h3>
                    <div class="card-tools d-flex align-items-center">
                        <a href="#" wire:click="toggle_show_add_palierprivilege" class="btn btn-link text-white mr-4 d-block">
                ...
                <div class="card-body table-responsive p-0 table-striped" style="height: 300px;">
                    <table class="table table-head-fixed text-nowrap">
                        <thead>
                            <tr>
                                <th style="width:25%">Palier privileges d'articles</th>
                                <th style="width:25%">Nombre de points</th>
                                <th style="width:25%" class="text-center">Date d'ajout</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >
                                    <input class="form-control @error('new_palierprivilege_name') is-invalid @enderror"
                                        type="text" wire:model.lazy="new_palierprivilege_name"
                                ...
                                <td >
                                    <input class="form-control @error('new_palierprivilege_point') is-invalid @enderror"
                                        type="text" wire:model.lazy="new_palierprivilege_point"
                                        wire:keydown.enter="add_new_palierprivilege">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-link" style="color:green ;" wire:click="add_new_palierprivilege"><i
                                            class="fa fa-check"> Valider</i> </button>
                                    <button class="btn btn-link" style="color:red ;"
                                        wire:click="toggle_show_add_palierprivilege"><i class="fas fa-trash-alt"> </i>
                                        Annuler</button>
                                </td>
                            </tr>
                            @endif
                            ...
                            <tr>
                                <td>{{$palierprivilege->nom_palierprivilege}}</td>
                                <td>{{$palierprivilege->nombre_points}}</td>
                                <td class="text-center">{{optional($palierprivilege->created_at)->diffForHumans()}}</td>
                                <td class="text-center">
                                    <button class="btn btn-link" wire:click="edit_palierprivilege({{$palierprivilege->id}})"><i
                                            class="far fa-edit"></i></button>
                                    <button class="btn btn-link" wire:click="confim_delete('{{$palierprivilege->nom_palierprivilege}}',{{$palierprivilege->id}})"><i class="fas fa-trash-alt"
