    ...
    <div class="row">
                    ...
                    <form wire:submit.prevent="update_user()">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('edit_user.boutique_id') is-invalid @enderror"
                                    ...
                                    <option value="4">Rue des jarrdin</option>
                                </select>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"
                                style="background-color: #10038f;color: #fff;">Modifier les informations de utilisateur</button>
        ...
        <div class="col-6 ">
            <div class="row">
                <div class="col-12 mt-4  ">
                    <div class="card mr-4">
                        <div class="card-header d-flex align-items-center" style="background-color: #10038f;color: #fff;">
